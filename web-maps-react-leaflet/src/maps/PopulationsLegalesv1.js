...
const PopulationsLegalesv1 = ({ geoJSONData }) => {
    ...
    useEffect(() => {
        const fetchInseeData = async () => {
            try {
                ...
                console.error('Erreur lors de la récupération des données Populations Légales INSEE : ', error);
            }
        }
        fetchInseeData();
    }, []);
...
export default PopulationsLegalesv1